...
this.main = function (opt)
    ...
    --
    --local dataPath = "/mnt/data/datasets/Text/amazon-review-full/word-t7"
    local dataPath = "/data/datasets/Text/amazon-review-full/word-t7"
    --local dataPath = "/home/ps/data/amazon-review-full/word-t7"
