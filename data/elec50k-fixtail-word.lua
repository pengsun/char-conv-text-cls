...
this.main = function (opt)
    ...
    --
--    local dataPath = "/mnt/data/datasets/Text/elec/tr50k-word-t7"
    local dataPath = "/data/datasets/Text/elec/tr50k-word-t7"
--    local dataPath = "/home/ps/data/elec/tr50k-word-t7"
