...
this.main = function (opt)
    ...
    --
    --local dataPath = "/mnt/data/datasets/Text/amazon-review-polarity/word-t7-rie"
    local dataPath = "/data/datasets/Text/amazon-review-polarity/word-t7-rie"
    --local dataPath = "/home/ps/data/amazon-review-polarity/word-t7-rie"
