...
this.main = function (opt)
    ...
    --
    --local dataPath = "/mnt/data/datasets/Text/yahoo-answers/word-t7-rie"
    local dataPath = "/data/datasets/Text/yahoo-answers/word-t7-rie"
    --local dataPath = "/home/ps/data/yahoo-answers/word-t7-rie"
