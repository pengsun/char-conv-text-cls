...
this.main = function (opt)
    ...
    --
    --local dataPath = "/mnt/data/datasets/Text/yelp-review-full/word-t7"
    local dataPath = "/data/datasets/Text/yelp-review-full/word-t7"
    --local dataPath = "/home/ps/data/yelp-review-full/word-t7"
