...
this.main = function (opt)
    ...
    --
    --local dataPath = "/mnt/data/datasets/Text/elec/tr100k-word-t7"
    local dataPath = "/data/datasets/Text/elec/tr100k-word-t7"
    --local dataPath = "/home/ps/data/elec/tr100k-word-t7"
