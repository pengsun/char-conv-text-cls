...
opt = {
    envContinuePath = path.join(
        'cv', 'imdb-fixtail-word-transfer',
        'M475-HU500-pretr.cv2maxcv3max-o_epoch4.00_lossval0.2619_errval10.70.t7'
    ),
    envSavePath = path.join('cv', 'imdb-fixtail-word-transfer'),
    maxEp = 40,
