...
this.main = function (opt)
    ...
    --
    --local dataPath = "/mnt/data/datasets/Text/yelp-review-polarity/word-t7"
    local dataPath = "/data/datasets/Text/yelp-review-polarity/word-t7"
    --local dataPath = "/home/ps/data/yelp-review-polarity/word-t7"
    ...
    if dataMask.tr == true then
        local fntr = path.join(dataPath, 'trtr.t7')
    ...
    if dataMask.val == true then
        local fnval = path.join(dataPath, 'trval.t7')
