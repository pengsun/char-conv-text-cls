...
this.main = function(opt)
    ...
    local indUnknown = 1
    local mconv = ohnn.OneHotTemporalSeqConvolution(V, HU, KH, {hasBias = true})
    local mcontrol = ohnn.OneHotTemporalSeqConvolution(V, HU, 1, {hasBias = false})
    ...
    local function make_controller(cw)
        ...
        -- B, M, HU
        md:add( ohnn.TemporalAddBias(HU) )
